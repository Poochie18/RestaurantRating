...
const dictionary = {
  ...
  optional: { uk: "необов'язково", en: "optional" },
  restaurantNameRequired: { uk: "Вкажіть назву ресторану.", en: "Restaurant name is required." },
  restaurantSaveFailed: { uk: "Не вдалося зберегти ресторан.", en: "Failed to save restaurant." },
  ...
  openStatistics: { uk: "Відкрити статистику", en: "Open statistics" },
  statisticsTitle: { uk: "Статистика просторів", en: "Space statistics" },
  statisticsSubtitle: {
    uk: "Оберіть простір, щоб переглянути аналітику, графіки та активність команди.",
    en: "Choose a space to see analytics, charts, and team activity."
  },
  statisticsEmpty: { uk: "Немає просторів для статистики.", en: "No spaces available for statistics." },
  statisticsOpenSpace: { uk: "Переглянути аналітику", en: "View analytics" },
  statisticsBackToList: { uk: "До всіх просторів", en: "Back to all spaces" },
  statisticsOverview: { uk: "Огляд", en: "Overview" },
  statisticsTotalRestaurants: { uk: "Ресторанів", en: "Restaurants" },
  statisticsTotalRatings: { uk: "Оцінок", en: "Ratings" },
  statisticsActiveRaters: { uk: "Активних оцінювачів", en: "Active raters" },
  statisticsAverageScore: { uk: "Середній бал", en: "Average score" },
  statisticsTopRestaurant: { uk: "Топ-ресторан", en: "Top restaurant" },
  statisticsNoTopRestaurant: { uk: "Ще немає даних", en: "No data yet" },
  statisticsCategoryAverages: { uk: "Середні оцінки по категоріях", en: "Average by category" },
  statisticsRestaurantLeaderboard: { uk: "Рейтинг ресторанів", en: "Restaurant leaderboard" },
  statisticsTopBestRestaurants: { uk: "Топ 5 найкращих ресторанів", en: "Top 5 best restaurants" },
  statisticsTopWorstRestaurants: { uk: "Топ 5 найгірших ресторанів", en: "Top 5 worst restaurants" },
  statisticsNoRestaurants: { uk: "У цьому просторі ще немає ресторанів.", en: "No restaurants in this space yet." },
  statisticsContributors: { uk: "Внесок учасників", en: "Member contributions" },
  statisticsContributorUser: { uk: "Учасник", en: "Member" },
  statisticsContributorCount: { uk: "К-сть оцінок", en: "Ratings count" },
  statisticsContributorAvg: { uk: "Середній бал", en: "Average score" },
  statisticsNoRatings: { uk: "Ще немає оцінок для аналітики.", en: "No ratings yet for analytics." },
  statisticsChartScaleHint: { uk: "Шкала 1-10", en: "Scale 1-10" },
  statisticsLoadError: { uk: "Не вдалося завантажити статистику.", en: "Failed to load statistics." },
